...
export const HabitForm = (props: Props) => {
    ...
    return (
        <div className="">
            ...
            <div
                className="border-gray-200 border-4 rounded-lg p-3"
            >
                <div className="flex items-center justify-between">
                    <h2 className="block  text-xs font-medium text-gray-600 uppercase">Weight <span className="text-red-600">*</span></h2>
                </div>
