...
const Login = () => {
  ...
  useEffect(() => {
    ...
    getAuthProviders().catch((error: ClientResponseError) => {
      console.log(error)
    })
  }, [client.users])
  ...
  return (
    <div className="flex flex-col min-h-screen justify-center items-center">
      <div className="max-w-md w-full space-y-4 px-4 sm:px-0 overflow-hidden">
        <div className="w-46 h-46 mx-auto items-center flex justify-center">
          <Image
        ...
        <Heading>Pocketbase Next.js Template</Heading>
        <div className="relative h-96">
          ...
          >
            <SubHeading>App Sign In</SubHeading>
            <InputField name="email" label="Email" icon={EnvelopeIcon} required={true} type="email" />
            <InputField name="password" label="Password" icon={LockClosedIcon} required={true} type="password" />
          ...
          >
            ...
            <InputField name="recoverEmail" label="Email" icon={EnvelopeIcon} required={true} type="email" />
