    ...
    return (
        <div className="">
            <div className="mx-auto sm:max-w-lg">
                ...
                <div
                    className="mt-20 flex flex-col space-y-2 justify-between items-center px-6"
                >
                    <div
                        className="w-full flex flex-col space-y-2"
                    >
                        <p><Tooltip title="Name" placement="top"><UserIcon className="w-5 h-5 inline-block" /></Tooltip> {user?.firstName} {user?.lastName}</p>
