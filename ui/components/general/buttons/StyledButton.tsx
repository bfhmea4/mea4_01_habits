...
const StyledButton = (props: StyledButtonProps) => {
  const hoverAnimationClasses = classNames(
    props.type === StyledButtonType.Primary
      ? "active:hover:bg-primary-dark sm:hover:bg-primary-dark"
      : "",
    props.type === StyledButtonType.Secondary
      ? "active:hover:bg-primary-darksm:hover:bg-primary-dark"
      : "",
    props.type === StyledButtonType.Danger
      ? "active:hover:bg-red-700 sm:hover:bg-red-700"
      : "",
