create table habit (id int8 generated by default as identity, created_at timestamp, description varchar(255), edited_at timestamp, frequency varchar(255), frequency_value int8, title varchar(255), primary key (id));
