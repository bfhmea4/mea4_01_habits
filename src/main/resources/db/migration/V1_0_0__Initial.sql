create table habit (id int8 generated by default as identity, created_at timestamp, edited_at timestamp, title varchar(255), description varchar(255), primary key (id));
