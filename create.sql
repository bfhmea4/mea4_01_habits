create table habit (id int8 generated by default as identity, created_at timestamp, description varchar(255), edited_at timestamp, title varchar(255), primary key (id));
